...
GREEK_ALIASES = {
    ...
    "β' κατηγορίας": "SKILL_BOOKS_B_CLASS",
    "β' κατηγορία": "SKILL_BOOKS_B_CLASS",
    "β΄ κατηγορίας": "SKILL_BOOKS_B_CLASS",
    "β΄ κατηγορία": "SKILL_BOOKS_B_CLASS",
    "γενική λογιστική (β' κατηγορίας)": "SKILL_BOOKS_B_CLASS",
    ...
    "φ.μ.υ.": "SKILL_TAX_DECLARATIONS",
    "ε3": "SKILL_TAX_DECLARATIONS",
    "ε1": "SKILL_TAX_DECLARATIONS",
    "ε 3": "SKILL_TAX_DECLARATIONS",
    "ε 1": "SKILL_TAX_DECLARATIONS",
    "ε-3": "SKILL_TAX_DECLARATIONS",
    "ε-1": "SKILL_TAX_DECLARATIONS",
    "ενφια": "SKILL_TAX_DECLARATIONS",
    "ενφιά": "SKILL_TAX_DECLARATIONS",
    "φορολογικός έλεγχος": "SKILL_TAX_DECLARATIONS",
    "φορολογική νομοθεσία": "SKILL_TAX_DECLARATIONS",
    "εργατική νομοθεσία": "SKILL_PAYROLL",
    # Sales/Retail Skills
    ...
    "πτυχιούχος": "bachelor",
    "bachelor": "bachelor",
    "πανεπιστήμιο": "bachelor",
    "πανεπιστημιο": "bachelor",
    "μεταπτυχιακό": "master",
    "μεταπτυχιακο": "master",
    "master": "master",
    "mba": "master",
    ...
    "phd": "doctorate",
    "doctorate": "doctorate",
    # Education fields - Greek accounting/business
    "λογιστική": "accounting",
    "λογιστικη": "accounting",
    "λογιστικής": "accounting",
    "οικονομικά": "economics",
    "οικονομικα": "economics",
    "οικονομικών": "economics",
    "διοίκηση επιχειρήσεων": "business_administration",
    "διοικηση επιχειρησεων": "business_administration",
    "χρηματοοικονομικά": "finance",
    "χρηματοοικονομικα": "finance",
    "συναφής κλάδος": "related_field",
    "συναφούς κλάδου": "related_field",
    "συναφους κλαδου": "related_field",
    "συναφές πτυχίο": "related_field",
    "σχετικό πτυχίο": "related_field",
    # ==========================================================================
    # DRIVING LICENSES
    # ==========================================================================
    "δίπλωμα": "B",
